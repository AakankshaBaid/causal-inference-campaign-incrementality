...
| Relationship stability | PASS | 1.0007 | forecast error 1.00x from older to recent origins (1.94% to 1.94%); early vs late pre-period counterfactuals diverge 1.94% |
